      ...
      <li class="nav-item active">
        ...
        <div id="collapseForm" class="collapse show" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="form_advanceds">Form Advanceds</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
...
<?php /**PATH /Users/lamina/Desktop/Xarala/laravel/Template/resources/views/form_advanceds.blade.php ENDPATH**/ ?>